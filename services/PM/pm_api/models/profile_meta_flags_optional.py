...
class ProfileMetaFlagsOptional(BaseModel):
    ...
    geolocation_masking: Optional[MaskingNCM] = None
    ...
    __properties: ClassVar[List[str]] = ["navigator_masking", "audio_masking", "localization_masking", "geolocation_popup", "geolocation_masking", "timezone_masking", "graphics_noise", "graphics_masking", "webrtc_masking", "fonts_masking", "media_devices_masking", "screen_masking", "proxy_masking", "ports_masking", "quic_mode"]
