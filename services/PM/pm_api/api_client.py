...
from pm_api.api_response import ApiResponse, T as ApiResponseT
import pm_api.models
from pm_api import rest
from pm_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pm_api.models, klass)
